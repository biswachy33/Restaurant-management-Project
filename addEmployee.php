...
if ($name && $email && $password && $repeat_password && $usertype && $phone_number) {
    ...
    die('Could not connect: ' . mysql_error());
        ...
        echo "<script>alert('Employee has been added is successfully')</script>";
        ...
        echo "<script>location.href ='adminDashboard.php'</script>";
    ...
    } else
         {
            ...
            echo "<script>location.href ='addEmployee.html'</script>";
        }
    ...
    {
    echo "<script>alert('You have to complete the add employee form!')</script>";
    echo "<script>location.href ='addEmployee.html'</script>";
