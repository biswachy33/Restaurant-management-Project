...
$(document).ready(function(){
  ...
  $("#ci").click(function(){
    $("#contents").load("table3.php");
  });

  $("#co").click(function(){
    $("#contents").load("table4.php");
  });
...
<div class="container"  style="background-color:#E6D3F2;"> <Center><h2><Center>ADMIN DASHBOARD</center></h2>
    ...
    <div class="col-2"><a href="addAdmin.html">Add Admin</div>
   <div class="col-2"><a href="addEmployee.html">Add Employee</div>
   <div class="col-2"><a href="all_users.php">View/Delete User</div>
    ...
    <div class="row" style="margin:25px;height:90%;">
            ...
            <div class="list-group-item list-group-item-info"><a id="ci"  href="#"> Clockin</a></div>
            <div class="list-group-item list-group-item-info"><a id="co"  href="#"> Clockout</a></div>
