...
<h1>
 <form action="http://studentvalleyrestaurant.epizy.com/index.html">
    <input type="submit" value="Home"></form></h1></body>
...
<div class="container"  style="background-color:#E6D3F2;">
    ...
    <div class="col-4"><h2>Menu Dashboard</h2></div>
      </div>
           ...
           <div class="container" style="width:700px;">  
                ...
                <div class="col-md-4">  
                     ...
                     <form method="post" action="redirectToLogin.html?action=add&id=<?php echo $row["id"]; ?>">  
                           ...
                           echo '<img src="../VCodeFolder/images\\'.$row["id"].'.jpg" height="180px" width="170px">';
                            ?>
                               ...
                               <input type="hidden" name="hidden_price" value="<?php echo $row["price"]; ?>" />  
                                ...
                                <a href="http://studentvalleyrestaurant.epizy.com/newAccount.html">Add to cart</a>
  ...
  <center>
                          ...
                          <a href="http://studentvalleyrestaurant.epizy.com/newAccount.html">
